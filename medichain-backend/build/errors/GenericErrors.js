...
const errors = {
    ...
    maximum_organization_limit: new ApiError(429, "Organization Limit Reached").withDescription("Maximum organization limit of 4 has been reached for you. Please upgrade before adding more"),
